...
const MAX_SCAN_POINTS = Number(process.env.MAX_SCAN_POINTS || 720);
const MAX_POINT_CLOUD_POINTS = Number(process.env.MAX_POINT_CLOUD_POINTS || 80000);
...
// Convert sensor_msgs/LaserScan to polar readings.
// Filters NaN, Infinity, zero, sub-range_min, super-range_max samples.
// Angle output is in degrees [0, 360) for backward compatibility with the 2D view.
